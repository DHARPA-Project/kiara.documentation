...
black: ## run black
	black --config pyproject.toml setup.py src/kiara_documentation tests

flake: ## check style with flake8
	flake8 src/kiara_documentation tests

mypy: ## run mypy
	mypy  --namespace-packages --explicit-package-base src/kiara_documentation
